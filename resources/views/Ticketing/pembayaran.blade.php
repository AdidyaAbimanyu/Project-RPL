        ...
        <div class="bg-success-2 flex-fill">
                <div class="row d-flex h-100 align-items-center">
                    <div class="col-6 d-flex flex-column align-items-center">
                        <a href="pembayaran/qris.html" class="text-decoration-none">
                            <div class="card text-center border-0 rounded-4" style="width: 28rem;">
                                <div class="card-body">
                                    <img src="\source\QRIS.png" alt="" width="300px">
                    ...
                    <div class="col-6 d-flex justify-content-center">
                        <a href="pembayaran/debit.html" class="text-decoration-none">
                            <div class="card text-center border-0 rounded-4" style="width: 28rem;">
                                <div class="card-body">
                                    <img src="\source\Debit.png" alt="" width="300px">
